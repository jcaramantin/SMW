//este script sirve para jugar una carta en una respectiva posicion
if(card_selected.played==false)
{
	if(point_distance(card_selected.x,card_selected.y,played_pos_1_x,played_pos_1_y)<=20)
	{
...
else if(point_distance(mouse_x,mouse_y,played_pos_3_x,played_pos_3_y)<=20)
		{
		...
		{
		card_selected.x=card_selected.start_x;
		card_selected.y=card_selected.start_x;
		}
